...
data_lines = data_lines.replace('"material": 70,', '"material": 6,')#FUSELASGE1
data_lines = data_lines.replace('"material": 71,', '"material": 10,')#LIGHTS

data_lines = data_lines.replace('"material": 72,', '"material": 11,')#FROST
data_lines = data_lines.replace('"material": 73,', '"material": 29,')#HUBLOTx

data_lines = data_lines.replace('"material": 76,', '"material": 22,')#GLASS
