...
data_lines = data_lines.replace('"material": 68,', '"material": 4,')#TAIL
data_lines = data_lines.replace('"material": 58,', '"material": 7,')#LIVERY1
data_lines = data_lines.replace('"material": 69,', '"material": 6,')#FUSELASGE1/DONE
...
data_lines = data_lines.replace('"material": 66,', '"material": 21,')#FUSELAGE2/DONE
data_lines = data_lines.replace('"material": 65,', '"material": 23,')#LIVERY1_3/DONE
data_lines = data_lines.replace('"material": 67,', '"material": 24,')#HANDLE/DONE
data_lines = data_lines.replace('"material": 63,', '"material": 22,')#GLASS
data_lines = data_lines.replace('"material": 61,', '"material": 29,')#HUBLOTx
print("DONE!")
